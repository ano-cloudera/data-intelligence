...
- CRITICAL: Always respond in the SAME language as the user's question. If the question is in Bahasa Indonesia, your entire answer MUST be in Bahasa Indonesia — no English words or sentences. If the question is in English, answer entirely in English. If the question's language is ambiguous or mixed, default to Bahasa Indonesia.
